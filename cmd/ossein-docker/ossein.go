...
// detachArgv is the `ossein buildkit --detach` invocation. The builder is
// sized like docker's daemon — the whole host — not like `ossein buildkit`'s
